...
bool FMCPToolRegistry_ToolsRegistered::RunTest(const FString& Parameters)
{
	...
	// Animation Blueprint tools removed from 4.25 port (API drift).
...
// Animation Blueprint tool tests removed from 4.25 port (tool excluded).
...
// Enhanced Input tests removed from 4.25 port (plugin not available).
